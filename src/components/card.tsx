    ...
    <div className="flex justify-center items-center h-screen bg-blue-bg">
      <div className=" w-full relative max-w-xs">
        ...
        <div className="relative shadow-xl bg-gray-900 border border-gray-800 p-4 h-full overflow-hidden rounded-2xl">
          ...
          <div className="py-5">
            <a href="#">
              <h5 className="text-xl font-bold text-white hover:text-emerald-400 transition-colors duration-300 mb-5">
                {card.title}
              </h5>
            </a>
          ...
          <div className="border-t border-blue-200 border-opacity-20 pt-2">
            <div className="flex items-center mt-3">
              <img
                src={card.creatorImageUrl}
                alt={`Creator ${card.creatorName}`}
                className="border-white border w-8 rounded-full mr-3"
              />
              <div>
                <span className="text-sm text-blue-300">Creation of </span>
                <a href="#">
                  <span className="text-sm text-white hover:text-emerald-400 transition-colors duration-300">
                    {card.creatorName}
                  </span>
                </a>
              </div>
